...
public class ModBlocks {
    ...
    public static final RegistryObject<FlowerPotBlock> POTTED_ANCIENT_OAK_SAPLING = registerBlockOnly("potted_ancient_oak_sapling",
    ...
    public static final RegistryObject<FlowerPotBlock> POTTED_EUCALYPTUS_SAPLING = registerBlockOnly("potted_eucalyptus_sapling",
    ...
    public static final RegistryObject<Block> SEQUOIA_LEAVES = registerBlock("sequoia_leaves",
        ...
        public static final RegistryObject<FlowerPotBlock> POTTED_SEQUOIA_SAPLING = registerBlockOnly("potted_sequoia_sapling",
    ...
    public static final RegistryObject<FlowerPotBlock> POTTED_OPEN_DREAMFLOWER = registerBlockOnly("potted_open_dreamflower",
            () -> new FlowerPotBlock(ModBlocks.OPEN_DREAMFLOWER.get(), setIdProperty("potted_open_dreamflower", BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OPEN_EYEBLOSSOM))));

    public static final RegistryObject<FlowerPotBlock> POTTED_CLOSED_DREAMFLOWER = registerBlockOnly("potted_closed_dreamflower",
            () -> new FlowerPotBlock(ModBlocks.CLOSED_DREAMFLOWER.get(), setIdProperty("potted_closed_dreamflower", BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_CLOSED_EYEBLOSSOM))));
    ...
    public static <T extends Block> RegistryObject<T> registerBlockOnly(String name, Supplier<T> block) { return BLOCKS.register(name, block); }
