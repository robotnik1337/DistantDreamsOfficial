...
public class ModItemTagProvider extends VanillaItemTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider pProvider) {
        ...
        tag(ItemTags.STAIRS)
                ...
                .add(ModBlocks.DISTANT_COBBLESTONE_STAIRS.get().asItem())
                .add(ModBlocks.MOSSY_DISTANT_COBBLESTONE_STAIRS.get().asItem())
        ...
        tag(ItemTags.SLABS)
                ...
                .add(ModBlocks.DISTANT_COBBLESTONE_SLAB.get().asItem())
                .add(ModBlocks.MOSSY_DISTANT_COBBLESTONE_SLAB.get().asItem())
        ...
        tag(ItemTags.WALLS)
                ...
                .add(ModBlocks.DISTANT_COBBLESTONE_WALL.get().asItem())
                .add(ModBlocks.MOSSY_DISTANT_COBBLESTONE_WALL.get().asItem())
